...
public class FragmentAddEvent extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dateTimeFormat = getString(R.string.full_date_format);
    ...
    private void setDefaultNotification() {
        ...
        notificationText.setText(WordUtils.capitalize(
                new SimpleDateFormat(getString(R.string.full_date_format)).format(notificationDate.getTime())));
    }
        ...
        eventTypeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    if (eventType == Event.eventType.Homework || eventType == Event.eventType.Test) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
                ...
                if(!checkFields())
                    ...
                    try {
                        ...
                        if (FirebaseUser.isLogged())
                            FirebaseUser.saveEvent(newEvent);
            ...
            case (R.id.manage_subjects_button):
                ((MainActivity)getActivity()).fragmentTransaction(new FragmentManageSubjects(),true,R.id.navManageSubjects);
        }
    }
